    ...
    <div class="columns">
        ...
        <div class="column">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" id="dropdown-menu" role="menu">
                    <div class="dropdown-content">
                      <a href="https://drive.google.com/file/d/1M9WwGUXJq6CMx-ZiM4nPrVPdGzHLHLRW/view?usp=sharing" class="dropdown-item" target="_blank" rel="noopener noreferrer" >
                        Chapter 1 Notebook - Colab 
                      </a>
                    </div>
                    <div class="dropdown-content">
                      <a href="./notes/notes_ipynb/lecture1-introduction.ipynb" class="dropdown-item" target="_blank" rel="noopener noreferrer" >
                        Chapter 1 Notebook - ipynb 
                      </a>
                    </div>
                </div>
            </div>
